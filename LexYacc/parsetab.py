...
_lr_productions = [
  ...
  ('query -> forclauses whereclause returnclause','query',3,'p_query_1','MProjectParser.py',54),
  ('query -> forclauses returnclause','query',2,'p_query_2','MProjectParser.py',58),
  ('forclauses -> forclauses forclause','forclauses',2,'p_forclauses_1','MProjectParser.py',64),
  ('forclauses -> forclause','forclauses',1,'p_forclauses_2','MProjectParser.py',68),
  ('forclause -> FOR exprs','forclause',2,'p_forclause','MProjectParser.py',72),
  ('whereclause -> WHERE wexprs','whereclause',2,'p_whereclause_1','MProjectParser.py',77),
  ('wexprs -> wexprs AND wexpr','wexprs',3,'p_wexprs_1','MProjectParser.py',81),
  ('wexprs -> wexpr','wexprs',1,'p_wexprs_2','MProjectParser.py',85),
  ('wexpr -> VARIABLE DOT pathexpr condition VARIABLE DOT pathexpr','wexpr',7,'p_wexpr_1','MProjectParser.py',90),
  ('wexpr -> VARIABLE condition VARIABLE DOT pathexpr','wexpr',5,'p_wexpr_2','MProjectParser.py',94),
  ('wexpr -> VARIABLE condition VARIABLE','wexpr',3,'p_wexpr_3','MProjectParser.py',98),
  ('wexpr -> VARIABLE DOT pathexpr condition STRING','wexpr',5,'p_wexpr_4','MProjectParser.py',102),
  ('wexpr -> VARIABLE condition STRING','wexpr',3,'p_wexpr_5','MProjectParser.py',106),
  ('wexpr -> VARIABLE DOT pathexpr condition NUMBER','wexpr',5,'p_wexpr_6','MProjectParser.py',110),
  ('wexpr -> VARIABLE condition NUMBER','wexpr',3,'p_wexpr_7','MProjectParser.py',114),
  ('wexpr -> CONTAINS LPAREN VARIABLE DOT pathexpr COMMA STRING RPAREN','wexpr',8,'p_wexpr_8','MProjectParser.py',118),
  ('wexpr -> CONTAINS LPAREN VARIABLE COMMA STRING RPAREN','wexpr',6,'p_wexpr_9','MProjectParser.py',122),
  ('condition -> EQUAL','condition',1,'p_condition_1','MProjectParser.py',127),
  ('condition -> NOTEQUAL','condition',1,'p_condition_2','MProjectParser.py',131),
  ('condition -> GREATEREQUAL','condition',1,'p_condition_3','MProjectParser.py',135),
  ('condition -> GREATERTHAN','condition',1,'p_condition_4','MProjectParser.py',139),
  ('condition -> LESSEQUAL','condition',1,'p_condition_5','MProjectParser.py',143),
  ('condition -> LESSTHAN','condition',1,'p_condition_6','MProjectParser.py',147),
  ('exprs -> exprs COMMA expr','exprs',3,'p_exprs_1','MProjectParser.py',153),
  ('exprs -> expr','exprs',1,'p_exprs_2','MProjectParser.py',158),
  ('expr -> VARIABLE IN JSONLINES LPAREN INVERTEDCOMMA FILENAME INVERTEDCOMMA RPAREN DOT pathexpr','expr',10,'p_expr_1','MProjectParser.py',163),
  ('expr -> VARIABLE IN JSONLINES LPAREN INVERTEDCOMMA FILENAME INVERTEDCOMMA RPAREN','expr',8,'p_expr_2','MProjectParser.py',168),
  ('expr -> rexpr','expr',1,'p_expr_3','MProjectParser.py',173),
  ('pathexpr -> pathexpr DOT step','pathexpr',3,'p_pathexpr_1','MProjectParser.py',179),
  ('pathexpr -> step','pathexpr',1,'p_pathexpr_2','MProjectParser.py',184),
  ('step -> NAME LBRACKET selector RBRACKET','step',4,'p_step_1','MProjectParser.py',189),
  ('step -> NAME','step',1,'p_step_2','MProjectParser.py',194),
  ('selector -> <empty>','selector',0,'p_selector_2','MProjectParser.py',200),
  ('selector -> NUMBER','selector',1,'p_selector_1','MProjectParser.py',205),
  ('returnclause -> RETURN rexpr','returnclause',2,'p_returnclause_1','MProjectParser.py',211),
  ('rexpr -> VARIABLE DOT pathexpr','rexpr',3,'p_rexpr_1','MProjectParser.py',216),
  ('rexpr -> VARIABLE','rexpr',1,'p_rexpr_2','MProjectParser.py',221),
  ('rexpr -> LCBRACKET jsoncontents RCBRACKET','rexpr',3,'p_rexpr_3','MProjectParser.py',226),
  ('jsoncontents -> jsoncontents COMMA jsoncontent','jsoncontents',3,'p_jsoncontents_1','MProjectParser.py',231),
  ('jsoncontents -> jsoncontent','jsoncontents',1,'p_jsoncontents_2','MProjectParser.py',236),
  ('jsoncontent -> STRING COLON rexpr','jsoncontent',3,'p_jsoncontent','MProjectParser.py',241),
]
